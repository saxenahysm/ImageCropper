package com.shyam.imagecropper;
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeStampFormat = new SimpleDateFormat("yyyy_MM_dd_hhmmss");
        myDate = new Date();
        fileName = "img_" + timeStampFormat.format(myDate) + ".jpg";
        ...
        switch (requestCode) {
            case REQUEST_IMAGE_CAPTURE:
                if (resultCode == RESULT_OK) {
                    Log.d(TAG, "onActivityResult:getCacheImagePath " + getCacheImagePath(fileName));
                    Log.d(TAG, "onActivityResult:getCacheImagePath " + getCacheImagePath(fileName));
